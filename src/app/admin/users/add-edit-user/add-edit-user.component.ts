...
export class AddEditUserComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activatedRoute.paramMap.subscribe(
      params => {
        this.userId = <any>params.get('userId');
      ...
      this.userService.getUser(this.userId).subscribe(
        (user: IUser)=> {
          ...
          if(this.user.addresses.length) {
            this.user.addresses.forEach((address:any, index:any) => {
              this.addAddress();
  ...
  formatUser(user:any) {
    ...
    if(userObj.addresses.length) {
      userObj.addresses.forEach((address:any, i:any) => {
  ...
  loadCities(addressIndex:any, stateId:any): void {
